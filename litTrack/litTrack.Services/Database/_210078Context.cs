...
public static class ModelBuilderExtensions
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Recenzija>().HasData(
            ...
            new Recenzija { RecenzijaId = 9, KorisnikId = 4, KnjigaId = 14, Komentar = "Drugi dio je jednako dobar.", DatumDodavanja = new DateTime(2025, 1, 9, 12, 0, 0), BrojLajkova = 0, BrojDislajkova = 0, IsDeleted = false, VrijemeBrisanja = null },
